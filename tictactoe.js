...
If u choose to play against the computer,
the 'Computer Player' will use the getBestMove function to choose one of the best possible moves.
*/
...
function Board (options){
  ...
  function getResult(board,symbol){
      // receives a board, and the symbol of the player 
      //and returns an object with the result and an array of the winning line
  ...
  function getBestMove (board, symbol){
    // Receives a board, and the symbol of the player who has the next move.
    // Returns the cordinates of the move and a score for that move
    // (1 for winning, 0 for tie, and -1 for losing)
    ...
    for (var i=0 ; i<availableMoves.length ; i++){
      // Iterates over each available move.
      //If it finds a winning move it returns it immediately.
      //Otherwise it pushes a move and a score
      // to the availableMovesAndScores array.
